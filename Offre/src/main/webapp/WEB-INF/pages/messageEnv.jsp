...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    ArrayList<MessageEnvoye> messageClientRecus=dao.getAllMessageEnvoyerByClient(mail);
    ArrayList<MessageEnvoye> messageUserRecus=dao.getAllMessageEnvoyerByUser(mail);
...
<%if(client){ %>
				    ...
				    <div class="col-xs-12">
				      <div class="table-responsive">
				        <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover">
				          <caption class="text-center">La liste des vos messages envoyes</caption>
				          <thead>
				            <tr>
				              <th>Destinataire</th>
				              <th>Objet</th>
	        ...
	        <%}
			 ...
			 if(messages.size()==0 && clientMsg.getStatut().equals("admin")){%>
	        		   ...
	        		   <div class="row">
			     	<div class="msgAlert"><h2>Liste des Messages envoyes vide</h2></div> 
			       	 </div>
	       ...
	       <% }		 
	         ...
	         {%>
			          ...
			          <tbody>
			           ...
			           { %>
			          	   <%String prenomexpe=dao.getUsertbyEmail(msg.getDestinataire()).getPrenom();
			          		String nomexpe=dao.getUsertbyEmail(msg.getDestinataire()).getNom();	          		User u=dao.getUsertbyEmail(msg.getExpeditaire());
		    ...
		    <div class="col-xs-12">
	          ...
	          <tbody>
	           ...
	           { %>
	          	   ...
	          	   if(dao.getClientbyEmail(msg.getDestinataire()).getPrenom()!=null){
	          		 String prenomexpe=dao.getClientbyEmail(msg.getDestinataire()).getPrenom();
	          		String nomexpe=dao.getUsertbyEmail(msg.getExpeditaire()).getPrenom();
