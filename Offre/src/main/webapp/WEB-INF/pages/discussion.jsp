					   ...
					   <%if(u!=null){ 
	                    ...
	                    <div class="direct-chat-msg doted-border">
	                     ...
	                     <span class="direct-chat-name pull-left"><%=u.getNom() %> <%=u.getPrenom() %></span>
						  ...
						  <div class="direct-chat-info clearfix">
	                        <span class="direct-chat-timestamp pull-right">le <%=discussion.getDateEnvoie().getDate()%>-<%=discussion.getDateEnvoie().getMonth()+1%>-<%=discussion.getDateEnvoie().getYear()+1900%> a <%=discussion.getDateEnvoie().getHours() %>h:<%=discussion.getDateEnvoie().getMinutes() %>min</span>
	                      </div>
							<div class="direct-chat-info clearfix">
