...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    ArrayList<MessageEnvoye> messageClientRecus=dao.getAllMessageSupByClient(mail);
    ArrayList<MessageEnvoye> messageUserRecus=dao.getAllMessageSupByUser(mail);
...
<%if(client){ %>
				    ...
				    <div class="col-xs-12">
				      <div class="table-responsive">
				        <table summary="This table shows how to create responsive tables using Bootstrap's default functionality" class="table table-bordered table-hover">
				          <caption class="text-center">La liste des vos messages supprimes</caption>
				          <thead>
				            <tr>
				              <th>Expeditaire</th>
				              <th>Objet</th>
	        ...
	        <%}
			 ...
			 if(messages.size()==0 && clientMsg.getStatut().equals("admin")){%>
	        		   ...
	        		   <div class="row">
			     	<div class="msgAlert"><h2>Liste des Messages Supprimes vide</h2></div> 
			       	 </div>
